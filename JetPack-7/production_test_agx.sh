	...
	while $continue_test; do
		...
		case $choice in
			...
			5 )
				...
				;;
			6 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS4 -s 115200
				;;
			7 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS5 -s 115200
				;;
			8 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS6 -s 115200
				;;
			9 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS7 -s 115200
				;;
			10 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS0 -s 115200
				;;
			11 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS1 -s 115200
				;;
			12 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS2 -s 115200
				;;
			13 )
				sudo gnome-terminal -- gtkterm -p /dev/ttyS3 -s 115200
				;;
			14 )
